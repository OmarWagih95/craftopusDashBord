...
function DashboardPanel() {
  ...
  const panelItems=[
    ...
    {title: 'Orders',icon: <TbTruckDelivery size={20}  />,path:'/orders' },
    {title: 'Settings',icon: <IoIosSettings size={20}  />,path:'/categories' },
  ]
  const [selectedIndex,setSelectedIndex]= useState(0);
  return (
    <div className='hidden lg:flex gap-4 items-center py-3 flex-col top-0 left-0  sm:w-[15vw] lg:w-[25vw] min-h-screen h-auto bg-purple-700'>
